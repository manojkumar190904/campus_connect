...
const roleMenus: Record<CampusRole, RoleMenuItem[]> = {
  student: [
    ...
    { id: "student-announcements", label: "Announcements", href: "/portal/student/announcements", icon: "Megaphone" },
    ...
    { id: "student-assignments", label: "Assignments", href: "/portal/student/assignments", icon: "ClipboardCheck" },
  ...
  faculty: [
    ...
    { id: "faculty-classes", label: "My Classes", href: "/portal/faculty/classes", icon: "LibraryBig" },
    ...
    { id: "faculty-announcements", label: "Announcements", href: "/portal/faculty/announcements", icon: "Megaphone" },
    { id: "faculty-assignments", label: "Assignments", href: "/portal/faculty/assignments", icon: "ClipboardCheck" },
    { id: "faculty-qr-attendance", label: "QR Attendance", href: "/portal/faculty/qr-attendance", icon: "QrCode" },
    { id: "faculty-students", label: "Student List", href: "/portal/faculty/students", icon: "UsersRound" },
    { id: "faculty-timetable", label: "Timetable", href: "/portal/faculty/timetable", icon: "CalendarDays" },
    { id: "faculty-reports", label: "Reports", href: "/portal/faculty/reports", icon: "ShieldCheck" },
...
const exactRouteRoles: Record<string, CampusRole[]> = {
  ...
  "/portal/student/announcements": ["student"],
  "/portal/student/assignments": ["student"],
  ...
  "/portal/faculty/announcements": ["faculty"],
  "/portal/faculty/assignments": ["faculty"],
  "/portal/faculty/classes": ["faculty"],
  "/portal/faculty/students": ["faculty"],
  "/portal/faculty/reports": ["faculty"],
  "/portal/faculty/timetable": ["faculty"],
  "/portal/hod": ["hod"],
